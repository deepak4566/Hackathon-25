...
def createJira():
    ...
    url = "https://kvsvishnusai.atlassian.net/rest/api/3/issue"

    API_TOKEN = "ATATT3xFfGF0cTWSInt5D9BrHLVdLc5IOLtaJ6IQcCrONOGI5YGizUifLh8KPXZdAV21GEtGHxcV3yCJ74OnR6B1LJl4LyD5OA_vJDL0v1R9xXgzjvtnEmt3DVM39dzdou9B9M1J9_d3Ct8a9Ddl6K7lS-L_mxayH7J_AqvfLx3kNQsXgVCkZR8=A5EDF5D3"
    auth = HTTPBasicAuth("mahinprabha1997@gmail.com", API_TOKEN)
